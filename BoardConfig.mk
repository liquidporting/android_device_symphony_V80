...
# Kernel
TARGET_PREBUILT_KERNEL := device/symphony/V80/kernel
BOARD_KERNEL_CMDLINE :=
BOARD_CUSTOM_BOOTIMG_MK := device/symphony/V80/mkbootimg.mk
...
# TWRP-Specific
TARGET_RECOVERY_FSTAB := device/symphony/V80/recovery/root/etc/twrp.fstab
